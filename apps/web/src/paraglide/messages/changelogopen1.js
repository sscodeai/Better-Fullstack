...
*/
const changelogopen1 = /** @type {((inputs?: Changelogopen1Inputs, options?: { locale?: "en" | "es" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Changelogopen1Inputs, { locale?: "en" | "es" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_changelogopen1(inputs)
	if (locale === "es") return es_changelogopen1(inputs)
	return zh_changelogopen1(inputs)
});
