...
*/
const homeopenbuilder2 = /** @type {((inputs?: Homeopenbuilder2Inputs, options?: { locale?: "en" | "es" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Homeopenbuilder2Inputs, { locale?: "en" | "es" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_homeopenbuilder2(inputs)
	if (locale === "es") return es_homeopenbuilder2(inputs)
	return zh_homeopenbuilder2(inputs)
});
