...
*/
const hometestimonialstitleb3 = /** @type {((inputs?: Hometestimonialstitleb3Inputs, options?: { locale?: "en" | "es" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Hometestimonialstitleb3Inputs, { locale?: "en" | "es" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_hometestimonialstitleb3(inputs)
	if (locale === "es") return es_hometestimonialstitleb3(inputs)
	return zh_hometestimonialstitleb3(inputs)
});
