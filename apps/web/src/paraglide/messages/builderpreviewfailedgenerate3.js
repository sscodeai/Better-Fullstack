...
*/
const builderpreviewfailedgenerate3 = /** @type {((inputs?: Builderpreviewfailedgenerate3Inputs, options?: { locale?: "en" | "es" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Builderpreviewfailedgenerate3Inputs, { locale?: "en" | "es" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	return zh_builderpreviewfailedgenerate3(inputs)
});
